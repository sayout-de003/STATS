...
SECRET_KEY = 'django-insecure-e+dl7q$85jz6@^z8@+ykq&2)fguis!(d1br68sq#le+*x8p!-+'
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Stats API",
    "DESCRIPTION": "API for Stats platform",
    "VERSION": "0.1.0",
}
AUTH_USER_MODEL = "users.User"

ASGI_APPLICATION = "stats_project.asgi.application"
CHANNEL_LAYERS = {
    "default": {
